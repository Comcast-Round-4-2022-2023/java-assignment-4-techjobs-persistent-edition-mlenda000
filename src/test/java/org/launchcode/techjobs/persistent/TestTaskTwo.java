...
//        Pattern queryPattern = Pattern.compile("SELECT name FROM techjobs.employer WHERE location='St. Louis City';", Pattern.CASE_INSENSITIVE); //| Pattern.MULTILINE);
        Matcher queryMatcher = queryPattern.matcher(queryFileContents);
        System.out.println(queryPattern);
        System.out.println(queryMatcher);
